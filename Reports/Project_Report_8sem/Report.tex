...
\includepdf[pages={1}]{Project certificate page.pdf}
...
% \noindent
% % \vspace{2pt}
% % \textbf{\large \quad \quad \qquad Name 1}\qquad \qquad \qquad \qquad \textbf{\large 4SO20CS001}\\ \vspace{2pt}
...
% The cloud-based architecture supports remote monitoring, ensuring efficient resource utilization. 
...
\begin{itemize}
    ...
    % \begin{itemize}
    %     \item \textbf{Precision:} 90\%, indicating low false-positive rates.
...
% \hfill
  \hspace{0.1\textwidth}
  \begin{subfigure}[b]{0.3\textwidth} % Adjust width
      \centering
...
% \includepdf[pages=-]{GA6.pdf}
\includepdf[pages={1}]{Project_Report Baby (1).pdf}
% \includepdf[pages=-]{DB_Summary_report_230-IEEE-Saumya.pdf}
\includepdf[pages=-]{IEEE-conference-template-062824.pdf}
